...
public class SysMenuController extends BaseController {
    ...
    public CommonResult<List<SysMenu>> list(SysMenu menu) {
        return CommonResult.success(sysMenuService.selectMenuListByUserId(menu, LoginHelper.getUserId()));
    }
    ...
    public CommonResult<List<Tree<Long>>> treeSelect(SysMenu menu) {
        List<SysMenu> menus = sysMenuService.selectMenuListByUserId(menu, LoginHelper.getUserId());
